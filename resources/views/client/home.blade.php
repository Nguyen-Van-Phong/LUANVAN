    ...
    <div class="container">
        ...
        <div class="collection">
                ...
                <div class=" row ">
                    <div class="col-lg-4 col-md-4 col-12">
                        <div class="collection__content-post">
                            <a href="">
                                <img src="{{asset('fe')}}/images/collection4.jpg" alt="">
                            </a>
                        </div>
                    ...
                    <div class="col-lg-4 col-md-4 col-12">
                        <div class="collection__content-post">
                            <a href="">
                                <img src="{{asset('fe')}}/images/collection5.jpg" alt="">
                            </a>
                        </div>
                        <div class="collection__content-info">
                            <a href="">
                    ...
                    <div class="col-lg-4 col-md-4 col-12">
                        <div class="collection__content-post">
                            <a href="">
                                <img src="{{asset('fe')}}/images/collection3.jpg" alt="">
                            </a>
                        </div>
                        <div class="collection__content-info">
                            <a href="">
            ...
            <div class="products">
                ...
                <div class="content__more">
                    <a class="btn btn-primary" href="">
                        Xem tất cả các gấu bông teddy HOTTRENT
                    </a>
                </div>
            </div>
            <div class="products">
            ...
            <div class="products">
                ...
                <div class="content__more">
                    <a class="btn btn-primary" href="">
                        Xem tất cả các BTS HOA KHÔNG TÀN
                    </a>
                </div>
            </div>
            <div class="products">
